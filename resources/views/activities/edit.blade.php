            ...
            <div class="whitebk setborder">
                ...
                <form action="{{route('activities.store')}}" method="POST" class="f_body fs_body" id="activities" enctype="multipart/form-data">
                    ...
                    <div class="f_component form-group">
                        ...
                        <input class="form-control" value="{{old($activity->title)}}" name="title" type="text" placeholder="小活动，大标题">
                    </div>

                    <div class="f_component form-group" >
                        <p class="f_cTitle fs_cTitle">活动 · 封面</p>
                        <p class="f_cDescribe fs_cDescribe">可以选择一张代表性的封面哦。 </p>
                        <input type="file" name="cover" value="{{old($activity->cover)}}">
                    </div>

                    <div class="f_component form-group">
                        <p class="f_cTitle fs_cTitle">活动 · 介绍</p>
                        <p class="f_cDescribe fs_cDescribe">给活动一个简明的介绍吧。</p>
                        <input class="form-control" value="{{old($activity->intro)}}" type="text" name="intro">
                    </div>
                    <div class="f_component form-group" >
                        <p class="f_cTitle fs_cTitle">活动 · 地址</p>
                        <p class="f_cDescribe fs_cDescribe">线上线下，随时随地。 </p>
                        <input class="form-control" value="{{old($activity->place)}}" name="place" type="text" placeholder="如：××××××学校门口">
                    </div>
                    <div class="f_component form-group" >
                        ...
                        <div class="input-append date start_datetime col-sm-6" >
                            <input class="form-control" type="text" value="{{old($activity->start)}}" name="start" readonly placeholder="起始时间">
                            <span class="add-on"><i class="icon-remove"></i></span>
                            <span class="add-on"><i class="icon-calendar"></i></span>
                        </div>

                        <div class="input-append date end_datetime col-sm-6" >
                            <input class="form-control" type="text" value="{{old($activity->end)}}" name="end" readonly placeholder="截止时间">
                            <span class="add-on"><i class="icon-remove"></i></span>
                            <span class="add-on"><i class="icon-calendar"></i></span>
                        </div>
                    ...
                    <div class="f_component form-group">
                        ...
                        <textarea id="editor" name="content" class="form-control" placeholder="精彩打活动内容">{{old($activity->content)}}</textarea>
                    </div>
                    <div class="f_component">
